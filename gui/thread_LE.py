        ...
        while self.count == 0 :
            if self.startfrequency < 1000:
                for i in range(self.startfrequency, 1000, 50):
                    print(i)
                    if (self.signal & 1) == 1:  #signal is an odd number, continue the test
                        start = i
                        stop = i + 50
                        stopfre=stop
                        ...
                        self.startfrequency= stopfre           # record the stopfrequency, it will be used as startfrequency in the funciton 'Pause'
