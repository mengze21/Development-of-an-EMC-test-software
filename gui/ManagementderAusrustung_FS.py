...
class FS_EquipmentManagement(object):
    ...
    def retranslateUi(self, EquipmentManagement):
        ...
        # Sonde
        self.treeWidget.topLevelItem(4).setText(0, _translate("EquipmentManagement", "Sonde"))
        self.treeWidget.topLevelItem(4).child(0).setText(0, _translate("EquipmentManagement", "Name"))
        self.treeWidget.topLevelItem(4).child(0).setText(1, _translate("EquipmentManagement", "--"))
        self.treeWidget.topLevelItem(4).child(0).setText(2, _translate("EquipmentManagement", "xx.dll"))
        self.treeWidget.topLevelItem(4).child(0).setText(3, _translate("EquipmentManagement", "xxxxx"))
