...
import os
from thread_LS import External_LS
...
class Ui_TestWindow_LS(object):
    def setupUi(self, TestWindow):
        ...
        self.GeschwebtMagnitudeLineEdit.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        ...
        self.GeschwebtFrequenzLineEdit.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        ...
        self.GeklicktMagnitudeLineEdit.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        ...
        self.GeklicktFrequenzLineEdit.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("icon_materials/20.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
    ...
    def retranslateUi(self, TestWindow):
        ...
        TestWindow.setWindowTitle(_translate("TestWindow", "Leitungsgebundene Störfestigkeit"))
    ...
    def clicked_pause(self):
        ...
        if (self.calc.signal & 1) == 0:
            ...
            self.calc = External_LS(AnfangF=self.calc.Anfangsfrequency, frequenz_S=self.x, Spannung=self.y, frequenz_L=self.F1,Leistung=self.M1)
            self.calc.signal = 1
    ...
    def start_thread(self):
        ...
        self.calc = External_LS(AnfangF=AnfangF,frequenz_S=self.x,Spannung=self.y,frequenz_L= self.F1,Leistung= self.M1)
        self.calc.start()
        self.calc.signal=1
        self.calc.countChanged.connect(self.onCountChanged)
    ...
    def drawSollSpannung(self):
        ...
        if self.vol1.text() == "":
            #self.vol1.setText('10')
            Spannung1=10
        else: Spannung1 =int(self.vol1.text())
        if self.vol2.text() == "":
            Spannung2=10
        else:    Spannung2 = int(self.vol2.text())
        if self.vol3.text() == "":
            Spannung3=10
        else:       Spannung3 = int(self.vol3.text())
