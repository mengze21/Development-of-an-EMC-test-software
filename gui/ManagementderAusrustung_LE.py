...
class Ui_Kabel(object):
    ...
    def setupUi(self, Kabel):
        ...
        # default cable data
        # import default data of Kabel 11 and put them into the table 1
        # annotate the source of the data
        # annotate the creation time of the data
        self.fname1 = "./data/LMK 11 9KHZ-100MHZ.CSV"
        ...
        aFile1.close()
        rowCnt1 = len(allLine1)-3
        self.tableWidget1.setRowCount(rowCnt1)
        vectF1 = [0] * rowCnt1
        vectMag1 = [0] * rowCnt1
        for i1 in range(len(allLine1)):
            lineText1 = allLine1[i1+3].strip()
            lineText1 = lineText1.replace("(", "")
            lineText2 = lineText1.replace(")", "")
            # print(lineText2)
            strList1 = lineText2.split(',')  # 分割为字符串列表
        ...
        # default cable data
        # import default data of Kabel 12 and put them into the table 2
        # annotate the source of the data
        # annotate the creation time of the data
        self.fname2 = "./data/LMK 12 9KHZ-100MHZ.CSV"
    ...
    def retranslateUi(self, Kabel):
        ...
        self.UnitsEdit1.setItemText(0, _translate("Kabel", "dB"))
        ...
        self.UnitsEdit2.setItemText(0, _translate("Kabel", "dB"))
        ...
        item.setText(_translate("Kabel", "Faktor (dB)"))
        if self.MHzRadioButton2.isChecked():
    ...
    # import new data of Kabel 11 and put them into the table 1
    # annotate the source of the data
    # annotate the creation time of the data
    ...
    # import new cable data
    # import new data of Kabel 12 and put them into the table 2
    # annotate the source of the data
    # annotate the creation time of the data
    ...
    def diagramm_drawed_one(self):
        if self.MHzRadioButton1.isChecked():
            ...
            plt.ylabel("Dämpfung in dB", fontsize=12)
            plt.grid(True, which="both", ls='--')
            plt.tick_params(direction='inout')
            plt.xlim(xmin=0.009, xmax=150)
        ...
        if self.HzRadioButton1.isChecked():
            ...
            plt.ylabel("Kabeldämpfung in dB", fontsize=12)
            plt.grid(True, which="both", ls='--')
            plt.tick_params(direction='inout')
            plt.xlim(xmin=9000, xmax=150000000)
            plt.ylim(ymin=-5, ymax=1)
            plt.show()
...
# This class defines the "Gerätemanagement" window, which is for device management for 'leitungsgebundene Emissionsmessung'
# It's Qt-Designer file is "ManagementderAusrustung.ui" in folder "uifiles"
class LE_EquipmentManagement(object):
    def setupUi(self, EquipmentManagement):
        ...
        # initialization of the  Kabeldämpfungen
        self.frequenz1 = []
        self.magnitude1 = []
        self.frequenz2 = []
        self.magnitude2 = []
    ...
    def retranslateUi(self, EquipmentManagement):
        ...
        self.treeWidget.topLevelItem(0).setText(0, _translate("EquipmentManagement", "Receiver Mode"))
        self.treeWidget.topLevelItem(0).child(0).setText(0, _translate("EquipmentManagement", "ESPI - 1002955 "))
        self.treeWidget.topLevelItem(0).child(0).setText(1, _translate("EquipmentManagement", "--"))
        self.treeWidget.topLevelItem(0).child(0).setText(2, _translate("EquipmentManagement", "ESPI.dll"))
        self.treeWidget.topLevelItem(0).child(0).setText(3, _translate("EquipmentManagement", "GPIB0::20::INSTR"))
        self.treeWidget.topLevelItem(0).child(0).setText(4, _translate("EquipmentManagement",
                                                                       "verwendet nur Receiver-Mode"))
        self.treeWidget.topLevelItem(1).setText(0, _translate("EquipmentManagement", "System Kontroller"))
        self.treeWidget.topLevelItem(1).child(0).setText(0, _translate("EquipmentManagement", "HP 3488A - 0000"))
        self.treeWidget.topLevelItem(1).child(0).setText(1, _translate("EquipmentManagement", "--"))
        self.treeWidget.topLevelItem(1).child(0).setText(2, _translate("EquipmentManagement", "HP3488A.dll"))
        self.treeWidget.topLevelItem(1).child(0).setText(3, _translate("EquipmentManagement", "GPIB0::9::INSTR"))
        self.treeWidget.topLevelItem(1).child(0).setText(4, _translate("EquipmentManagement",
                                                                       "schaltet Verstärker, selbstgeschriebener Treiber"))
        self.treeWidget.topLevelItem(2).setText(0, _translate("EquipmentManagement", "Kabel"))
        self.treeWidget.topLevelItem(2).child(0).setText(0, _translate("EquipmentManagement", "LMK11"))
        self.treeWidget.topLevelItem(2).child(0).setText(1, _translate("EquipmentManagement", "--"))
        self.treeWidget.topLevelItem(2).child(1).setText(0, _translate("EquipmentManagement", "LMK12"))
        self.treeWidget.topLevelItem(2).child(1).setText(1, _translate("EquipmentManagement", "--"))
        self.treeWidget.topLevelItem(3).setText(0, _translate("EquipmentManagement", "Impulsbegrenzer"))
        self.treeWidget.topLevelItem(3).child(0).setText(0,
                                                         _translate("EquipmentManagement", "Impulsbebrenzer ESH3-Z2"))
        self.treeWidget.topLevelItem(3).child(0).setText(1, _translate("EquipmentManagement", "--"))
        self.treeWidget.topLevelItem(3).child(0).setText(4, _translate("EquipmentManagement",
                                                                       "10 dB, verwendet in leitungsbebundene Emission"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.listderausrustung),
                                  _translate("EquipmentManagement", "Liste der Ausrüstung"))
        ...
        self.KontrollerController.topLevelItem(0).child(0).child(0).setText(0, _translate("EquipmentManagement",
                                                                                          "Switch 1"))
        self.KontrollerController.topLevelItem(0).child(0).child(0).setText(1, _translate("EquipmentManagement",
                                                                                          "Switches Amplifiers"))
        self.KontrollerController.topLevelItem(0).child(0).child(0).child(0).setText(0,
                                                                                     _translate("EquipmentManagement",
                                                                                                "Common"))
        self.KontrollerController.topLevelItem(0).child(0).child(0).child(0).setText(1,
                                                                                     _translate("EquipmentManagement",
                                                                                                "-"))
        self.KontrollerController.topLevelItem(0).child(0).child(0).child(1).setText(0,
                                                                                     _translate("EquipmentManagement",
                                                                                                "Position 1"))
        self.KontrollerController.topLevelItem(0).child(0).child(0).child(1).setText(1,
                                                                                     _translate("EquipmentManagement",
                                                                                                "AR 100L 10kHz-220MHz-0000"))
        self.KontrollerController.topLevelItem(0).child(0).child(0).child(2).setText(0,
                                                                                     _translate("EquipmentManagement",
                                                                                                "Position 2"))
        self.KontrollerController.topLevelItem(0).child(0).child(0).child(2).setText(1,
                                                                                     _translate("EquipmentManagement",
                                                                                                "AR 100W1000M180 - 1000MHz - 0000"))
        self.KontrollerController.topLevelItem(0).child(0).child(0).child(3).setText(0,
                                                                                     _translate("EquipmentManagement",
                                                                                                "Position 3"))
        self.KontrollerController.topLevelItem(0).child(0).child(0).child(3).setText(1,
                                                                                     _translate("EquipmentManagement",
                                                                                                "AR 50S1G4 800MHz - 4.2GHz - 0000"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.systemcontroller),
                                  _translate("EquipmentManagement", "System Kontroller"))
    ...
    # e. g. if item "Kabel" is double clicked, the "Kabeldämpfungen" window will appear
    def openwindow(self,index):
        getSelected = self.treeWidget.selectedItems()
        if getSelected:
            baseNode = getSelected[0]
            getChildNode = baseNode.text(0)
            if getChildNode == "Kabel"  :                       #
