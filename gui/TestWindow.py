...
class Ui_TestWindow(object):
    def setupUi(self, TestWindow):
        ...
        self.__axisLabel = QtChart.QCategoryAxis()
        self.__axisLabel.setRange(10,30000)
        #self.__axisLabel.setMin(30000)
        self.__axisLabel.append('100 ',100)
        self.__axisLabel.append('150 ', 150)
        self.__axisLabel.append('1 MHz', 1000)
        self.__axisLabel.append('10 MHz', 10000)
        self.__axisLabel.append('30 MHz', 30000)
        self.chart.addAxis(self.__axisLabel, QtCore.Qt.AlignBottom)
        #self.__axisLabel.setLabelsPosition(QCategoryAxis::AxisLabelsPositionOnValue)
        self.__axisMag = QtChart.QValueAxis()
        self.__axisMag.setTitleText("Feldstärke / dBμV/m")
        self.__axisMag.setRange(-5, 65)
        self.__axisMag.setTickCount(15)
        self.__axisMag.setLabelFormat("%d")
        self.chart.addAxis(self.__axisMag, QtCore.Qt.AlignLeft)

        self.series_1.attachAxis(self.__axisLabel)
        self.series_1.attachAxis(self.__axisMag)

        self.series_2.attachAxis(self.__axisLabel)
        self.series_2.attachAxis(self.__axisMag)

        self.series_3.attachAxis(self.__axisLabel)
        self.series_3.attachAxis(self.__axisMag)

        self.series_4.attachAxis(self.__axisLabel)
    ...
    def clicked_pause(self):
        ...
        if (self.calc.signal & 1) == 0:
            ...
            self.calc = External(mode=mode, attenuation=antten, messtime=messtime, startfre=self.calc.startfrequency)
            self.calc.signal = 1
    ...
    def start_thread(self):
        ...
        if self.curve1.isChecked() == False and \
            ...
            messageBox.setText(
                'Bitte Dämpfungsglied verwenden !')
    ...
    def onCountChanged(self, value, num):
        ...
        real_PK = magnitude + Antena - kabel11 - kabel12
