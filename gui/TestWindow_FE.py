...
import os
from thread_FE import External_FE
...
class Ui_TestWindow_FE(object):
    def setupUi(self, TestWindow):
        ...
        self.cablem1 = vectMag1     # 1. Kabel D盲mpfungen

        # read the 2. Kabeld盲mpfungen
        ...
        self.cablem2 = vectMag2        # 2. Kabel D盲mpfungen
        ...
        self.__axisMag.setTitleText("Störspannung / dBµV")
        ...
        #neu
        #self.pushButton_4.setToolTip("zoom out")
        #neu
        icon4 = QtGui.QIcon()
        ...
        self.startfre1.setPlaceholderText("Standardwert: 30")
        ...
        self.startfre2.setPlaceholderText("Standardwert: 30")
        ...
        self.startfre3.setPlaceholderText("Standardwert: 30")
        ...
        self.startfre4.setPlaceholderText("Standardwert: 30")
    ...
    def retranslateUi(self, TestWindow):
        ...
        item.setText(_translate("TestWindow", "Anfangsfrequenz / MHz"))
    ...
    def do_series_hovered(self, point, state):
        if state:
            ...
            vertical_coor = "%.2f dB渭V/m" % point.y()
    ...
    def daten_exportieren(self):
        if self.curve1.isChecked() == False and \
            ...
            messageBox.setText(
                'Bitte w盲hlen Sie zuerst eine Kurve aus!')
    ...
    def on_actOpen_triggered(self):
        ...
        filename, flt = QtWidgets.QFileDialog.getOpenFileName(None, "Eine Datei 枚ffnen", curPath, "Testdaten (*.txt)")
        if (filename==""):
            return
    ...
    def start_thread(self):
        if self.curve1.isChecked() == False and \
            ...
            self.AktuellerZustandLineEdit.setText("Test l盲uft!")
            ...
            self.calc = External_FE(mode=mode, attenuation=antten, messtime=messtime, startfre=startfre)
            self.calc.signal=1
    ...
    def clicked_stop(self):
        ...
        self.calc.quit()
        time.sleep(2)
        self.AktuellerZustandLineEdit.setText("Test beendet! ")
    ...
    def drawnormlimit(self, norm):
        ...
        if "Gruppe 2. Klasse A. Quasi-Peak. 3m." in self.data:
            ...
            messageBox.setIcon(QtWidgets.QMessageBox.Warning)
            messageBox.setWindowIcon(QtGui.QIcon('./icon_materials/8.png'))
            messageBox.setText('Sorry, die Grenzwerte f眉r \"Gruppe 2. Klasse A. Quasi-Peak. 3m.\" in dieser Norm ist noch nicht definiert.')
            messageBox.setStandardButtons(QtWidgets.QMessageBox.Ok)
            buttonY = messageBox.button(QtWidgets.QMessageBox.Ok)
            buttonY.setText('Ok')
            messageBox.exec_()
        ...
        if "Gruppe 2. Klasse A. Quasi-Peak. 10m." in self.data:
            ...
            messageBox.setWindowIcon(QtGui.QIcon('./icon_materials/8.png'))
            messageBox.setText(
                'Sorry, die Grenzwerte f眉r \"Gruppe 2. Klasse A. Quasi-Peak. 10m.\" in dieser Norm ist noch nicht definiert.')
            messageBox.setStandardButtons(QtWidgets.QMessageBox.Ok)
            buttonY = messageBox.button(QtWidgets.QMessageBox.Ok)
            buttonY.setText('Ok')
            messageBox.exec_()
        ...
        if "Gruppe 2. Klasse A. Quasi-Peak. 30m." in self.data:
            ...
            messageBox.setWindowIcon(QtGui.QIcon('./icon_materials/8.png'))
            messageBox.setText(
                'Sorry, die Grenzwerte f眉r \"Gruppe 2. Klasse A. Quasi-Peak. 30m.\" in dieser Norm ist noch nicht definiert.')
            messageBox.setStandardButtons(QtWidgets.QMessageBox.Ok)
            buttonY = messageBox.button(QtWidgets.QMessageBox.Ok)
            buttonY.setText('Ok')
            messageBox.exec_()
        ...
        if "Gruppe 2. Klasse B. Quasi-Peak. 3m." in self.data:
            ...
            messageBox.setWindowIcon(QtGui.QIcon('./icon_materials/8.png'))
            messageBox.setText(
                'Sorry, die Grenzwerte f眉r \"Gruppe 2. Klasse B. Quasi-Peak. 3m.\" in dieser Norm ist noch nicht definiert.')
            messageBox.setStandardButtons(QtWidgets.QMessageBox.Ok)
            buttonY = messageBox.button(QtWidgets.QMessageBox.Ok)
            buttonY.setText('Ok')
            messageBox.exec_()
        ...
        if "Gruppe 2. Klasse B. Average. 3m." in self.data:
            ...
            messageBox.setWindowIcon(QtGui.QIcon('./icon_materials/8.png'))
            messageBox.setText(
                'Sorry, die Grenzwerte f眉r \"Gruppe 2. Klasse B. Average. 3m.\" in dieser Norm ist noch nicht definiert.')
            messageBox.setStandardButtons(QtWidgets.QMessageBox.Ok)
            buttonY = messageBox.button(QtWidgets.QMessageBox.Ok)
            buttonY.setText('Ok')
            messageBox.exec_()
        ...
        if "Gruppe 2. Klasse B. Quasi-Peak. 10m." in self.data:
            ...
            messageBox.setWindowIcon(QtGui.QIcon('./icon_materials/8.png'))
            messageBox.setText(
                'Sorry, die Grenzwerte f眉r \"Gruppe 2. Klasse B. Quasi-Peak. 10m.\" in dieser Norm ist noch nicht definiert.')
            messageBox.setStandardButtons(QtWidgets.QMessageBox.Ok)
            buttonY = messageBox.button(QtWidgets.QMessageBox.Ok)
            buttonY.setText('Ok')
            messageBox.exec_()
        ...
        if "Gruppe 2. Klasse B. Average. 10m." in self.data:
            ...
            messageBox.setWindowIcon(QtGui.QIcon('./icon_materials/8.png'))
            messageBox.setText(
                'Sorry, die Grenzwerte f眉r \"Gruppe 2. Klasse B. Average. 10m.\" in dieser Norm ist noch nicht definiert.')
            messageBox.setStandardButtons(QtWidgets.QMessageBox.Ok)
            buttonY = messageBox.button(QtWidgets.QMessageBox.Ok)
            buttonY.setText('Ok')
            messageBox.exec_()
